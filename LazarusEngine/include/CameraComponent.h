...
public:
	...
	CameraComponent() : m_position(0), m_orientation(1,0,0,0), m_fov(60) 
	{
	}
	
	CameraComponent(const glm::vec3& pos) : m_position(pos), m_orientation(1, 0, 0, 0),m_fov(60) {}
	CameraComponent(const glm::vec3& pos, const glm::quat& orient) : m_position(pos), m_orientation(orient), m_fov(60) {}
